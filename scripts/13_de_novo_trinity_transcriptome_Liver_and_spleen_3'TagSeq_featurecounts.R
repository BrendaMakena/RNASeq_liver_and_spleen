# Counting reads for the liver and spleen 3' TagSeq data mapped to de novo assembled 
# trinity transcriptome from E. labiatus and bat Hepatocystis using features counts 
...
bamdirectory <- "/SAN/RNASeqHepatoCy/HepatoTranscriptome/RNASeq_liver_and_spleen/3TagRNASeqs/STARmapping/filtered_transcriptome/E.labiatus_and_Hepatocystis_trinity_denovo_transcriptome_STARmapped/"
bamdirectory
...
saveRDS(RNASeqfeatureCounts, "/home/brenda/RNASeq_liver_and_spleen/intermediateData/3'TagSeq_CountTable_trinity_de_novo_transcriptome.RDS")
